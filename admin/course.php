...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,duration,descr,trainer) values('$coursecode','$coursename','$duration','$descr','$trainer')");
if($ret)
{
...
<div class="form-group">
    ...
    <textarea class="form-control" id="descr" name="descr" placeholder="Course Description" required ></textarea>
  </div> 
  
<div class="form-group">
    <label for="trainer">Course Trainer  </label>
    <input type="text" class="form-control" id="trainer" name="trainer" placeholder="Course Trainer" required />
  </div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['duration']);?></td>
                                             <td><?php echo htmlentities($row['descr']);?></td>
