                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($con,"select courseenrolls.course as cid, course.courseName as courname,department.department as dept,course.duration as duration, course.trainer as trainer, courseenrolls.enrollDate as edate ,students.studentName as sname,students.StudentRegno as sregno from courseenrolls join course on course.id=courseenrolls.course join department on department.id=courseenrolls.department join students on students.StudentRegno=courseenrolls.studentRegno ");
$cnt=1;
