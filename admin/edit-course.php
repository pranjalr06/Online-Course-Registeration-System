...
$ret=mysqli_query($con,"update course set courseCode='$coursecode',courseName='$coursename',duration='$duration',trainer='$trainer',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="duration" name="duration" placeholder="Course Duration" value="<?php echo htmlentities($row['duration']);?>" required />
  </div>  

<div class="form-group">
    <label for="trainer"> Trainer  </label>
    <input type="text" class="form-control" id="trainer" name="trainer" placeholder="trainer" value="<?php echo htmlentities($row['trainer']);?>" required />
  </div>  
