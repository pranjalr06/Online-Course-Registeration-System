                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                             ...
                             <li><a href="admin\index.php">Admin Login </a></li>
                              ...
                              <!-- <li><a href="index.php">Trainer Login</a></li> -->
            ...
            <div class="row">
                <div class="col-md-6">
                     <label>Enter Reg no : </label>
                        ...
                        <button type="submit" name="submit" class="btn btn-info"><span class="glyphicon glyphicon-user"></span><a href="s-registration.php" style="color:white">Register</button>&nbsp;
                </div>
                </form>
                <div class="col-md-6">
